...
<div class="container">
	...
	<h3>Staff list:</h3>
	<?php
		$db_array = User::find_all_by_what('status','"Activo"');
		if($db_array) {
	...
	<button onclick="location.href='user-create.php';" class="btn btn-primary">Add user</button>
	<button onclick="location.href='user-deleted.php';" class="btn btn-primary">Deleted users</button>
</div>
